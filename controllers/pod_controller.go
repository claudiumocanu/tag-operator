...
const (
	addPodNameLabelAnnotation = "claudiu.go/add-pod-name-label"
	podNameLabel              = "claudiu.go/pod-name"
)
...
func (r *PodReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	*/
	...
	/*
	   Step 1: Add or remove the label if and only if the annotation is present
	*/
